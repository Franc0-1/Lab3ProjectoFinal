...
export default function PizzasEdit({ auth, pizza, categories }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        preparation_time: pizza.preparation_time || 15,
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(safeRoute('pizzas.update', pizza.id));
    };
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Editar Pizza</h2>}
        >
            <Head title={`Editar ${pizza.name}`} />
                    ...
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div className="p-6 text-gray-900">
                            <div className="flex justify-between items-center mb-6">
                                <h1 className="text-2xl font-bold text-gray-900">Editar Pizza: {pizza.name}</h1>
                                <Link
